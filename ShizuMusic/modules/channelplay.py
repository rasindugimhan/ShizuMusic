...
from ShizuMusic.modules.play import generate_cover
from ShizuMusic.modules.play import arq
from ShizuMusic.modules.play import cb_admin_check
from ShizuMusic.modules.play import transcode
from ShizuMusic.modules.play import convert_seconds
from ShizuMusic.modules.play import time_to_seconds
from ShizuMusic.modules.play import changeImageSize
from ShizuMusic.config import BOT_NAME as bn
from ShizuMusic.config import DURATION_LIMIT
from ShizuMusic.config import UPDATES_CHANNEL as updateschannel
from ShizuMusic.config import que
from ShizuMusic.function.admins import admins as a
from ShizuMusic.helpers.errors import DurationLimitError
from ShizuMusic.helpers.decorators import errors
from ShizuMusic.helpers.admins import get_administrators
from ShizuMusic.helpers.channelmusic import get_chat_id
from ShizuMusic.helpers.decorators import authorized_users_only
from ShizuMusic.helpers.filters import command
from ShizuMusic.helpers.filters import other_filters
from ShizuMusic.helpers.gets import get_file_name
from ShizuMusic.services.callsmusic import callsmusic
from ShizuMusic.services.callsmusic import client as USER
from ShizuMusic.services.converter.converter import convert
from ShizuMusic.services.downloaders import youtube
from ShizuMusic.services.queues import queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/1d72d1665c7f7c7e1d9a2.jpg"
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    # print(e)
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in channel. If have a problem let us know @ShizuUpdates"
                        "\n\nOr manually add assistant to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @ShizuMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/1d72d1665c7f7c7e1d9a2.jpg"
