import os
from ShizuMusic.config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,UPDATES_CHANNEL
class Messages():
...
⭕ I can play music in your group's voice chat as well as channel voice chats. If have a problem contact @ShizuUpdates
